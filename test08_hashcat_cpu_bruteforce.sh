...
START=$(date +%s)
hashcat -m 1400 -a 3 -O --force --opencl-device-types 1  -n 4 hashes_weak.txt '?a?a?a?a?a?a'
END=$(date +%s)
...
START=$(date +%s)
hashcat -m 1400 -a 3 -O --force --opencl-device-types 1  -n 4 hashes_medium.txt '?a?a?a?a?a?a'
END=$(date +%s)
...
START=$(date +%s)
hashcat -m 1400 -a 3 -O --force --opencl-device-types 1  -n 4 hashes_strong.txt '?a?a?a?a?a?a'
END=$(date +%s)
