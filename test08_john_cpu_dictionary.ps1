...
cmd /c "cd john/run && john.exe --format=raw-sha256 --wordlist=..\..\realhuman_phill.txt --fork=6 ..\..\hashes\hashes_weak.txt" | Tee-Object -FilePath $OutputFile
...
cmd /c "cd john/run && john.exe --format=raw-sha256 --wordlist=..\..\realhuman_phill.txt --fork=6 ..\..\hashes\hashes_medium.txt" | Tee-Object -FilePath $OutputFile
...
cmd /c "cd john/run && john.exe --format=raw-sha256 --wordlist=..\..\realhuman_phill.txt --fork=6 ..\..\hashes\hashes_strong.txt" | Tee-Object -FilePath $OutputFile
