...
START=$(date +%s)
hashcat -m 1400 -a 3 -O --force --opencl-device-types 1  -n 1 hashes_weak.txt '?a?a?a?a?a?a'
END=$(date +%s)
...
START=$(date +%s)
hashcat -m 1400 -a 3 -O --force --opencl-device-types 1  -n 1 hashes_medium.txt '?a?a?a?a?a?a'
END=$(date +%s)
...
START=$(date +%s)
hashcat -m 1400 -a 3 -O --force --opencl-device-types 1  -n 1 hashes_strong.txt '?a?a?a?a?a?a'
END=$(date +%s)
