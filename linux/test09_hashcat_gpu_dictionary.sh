...
START=$(date +%s)
hashcat -m 1400 -a 0 -O --force  -d 1  hashes_weak.txt rockyou.txt
END=$(date +%s)
...
START=$(date +%s)
hashcat -m 1400 -a 0 -O --force  -d 1  hashes_medium.txt rockyou.txt
END=$(date +%s)
...
START=$(date +%s)
hashcat -m 1400 -a 0 -O --force  -d 1  hashes_strong.txt rockyou.txt
END=$(date +%s)
