...
$OutputFile = "test03_results.txt"
"" | Out-File -FilePath $OutputFile

Send-DiscordMessage ":hourglass: Starting Weak hashes"
$startTime = Get-Date
Remove-Item -ErrorAction SilentlyContinue hashcat.potfile
cmd /c "hashcat.exe -m 1400 -a 0 --potfile-disable --opencl-device-types 1 -n 6 hashes_weak.txt rockyou.txt -O" | Tee-Object -FilePath $OutputFile -Append
$endTime = Get-Date
...
$startTime = Get-Date
Remove-Item -ErrorAction SilentlyContinue hashcat.potfile
cmd /c "hashcat.exe -m 1400 -a 0 --potfile-disable --opencl-device-types 1 -n 6 hashes_medium.txt rockyou.txt -O" | Tee-Object -FilePath $OutputFile -Append
$endTime = Get-Date
$elapsed = ($endTime - $startTime).TotalSeconds
...
$startTime = Get-Date
Remove-Item -ErrorAction SilentlyContinue hashcat.potfile
cmd /c "hashcat.exe -m 1400 -a 0 --potfile-disable --opencl-device-types 1 -n 6 hashes_strong.txt rockyou.txt -O" | Tee-Object -FilePath $OutputFile -Append
$endTime = Get-Date
$elapsed = ($endTime - $startTime).TotalSeconds
