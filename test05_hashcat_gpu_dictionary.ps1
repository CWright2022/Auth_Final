...
cmd /c "cd hashcat && hashcat.exe -m 1400 -a 0 --potfile-disable   ..\hashes\hashes_weak.txt ..\realuniq.lst -O" | Tee-Object -FilePath $env:TEMP\test05_Weak_temp.txt
...
cmd /c "cd hashcat && hashcat.exe -m 1400 -a 0 --potfile-disable   ..\hashes\hashes_medium.txt ..\realuniq.lst -O" | Tee-Object -FilePath $env:TEMP\test05_Medium_temp.txt
...
cmd /c "cd hashcat && hashcat.exe -m 1400 -a 0 --potfile-disable   ..\hashes\hashes_strong.txt ..\realuniq.lst -O" | Tee-Object -FilePath $env:TEMP\test05_Strong_temp.txt
